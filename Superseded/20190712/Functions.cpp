...
/*double calculateAngle(double a, double b)
{
	...
	if (a == 0.0 && b > 0.0) { result = PI * 0.5; }
	if (a < 0.0 && b == 0.0) { result = PI; }
	if (a == 0.0 && b < 0.0) { result = PI ; }
	if (a > 0.0 && b > 0.0) { result = atan2f(b, a); }
	if (a < 0.0 && b > 0.0) { result = PI - atan2f(b, fabs(a)); }
	if (a < 0.0 && b < 0.0) { PI + atan2f(fabs(b), fabs(a)); }
	if (a > 0.0 && b < 0.0) { -atan2f(fabs(b), fabs(a)); }
...
{
	triangle3dV* target = new triangle3dV[n];
