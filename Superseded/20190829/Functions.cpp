...
{
	byte a, r, g, b, rSurplus, gSurplus, bSurplus;
	...
	r = red ? (byte)((inputColour >> 16 & 255) * illumination) : 0;
	g = green ? (byte)((inputColour >> 8 & 255) * illumination) : 0;
	b = blue ? (byte)((inputColour & 255) * illumination) : 0;

	/*if (red > 255)
	{
		rSurplus = red - 255;
		red = 255;
		green += int(rSurplus / 2);
		blue += int(rSurplus / 2);
	}*/
