...
triangle3dV* Revolved::getTriangleDataNT()
{
	return transformObject(this->getTotalPoly(), this->getTriangleDataN(), scaleX, scaleY, scaleZ,
							moveX, moveY, moveZ, rotX, rotY, rotZ);
}


void Revolved::setScaleX(double p)
{
	scaleX = p;
}


void Revolved::setScaleY(double p)
{
	scaleY = p;
}


void Revolved::setScaleZ(double p)
{
	scaleZ = p;
}


void Revolved::setMoveX(double p)
{
	moveX = p;
}


void Revolved::setMoveY(double p)
{
	moveY = p;
}


void Revolved::setMoveZ(double p)
{
	moveZ = p;
}


void Revolved::setRotX(double p)
{
	rotX = p;
}


void Revolved::setRotY(double p)
{
	rotY = p;
}


void Revolved::setRotZ(double p)
{
	rotZ = p;
}


void Revolved::setAllTransforms(double sX, double sY, double sZ, double mX, double mY, double mZ, double rX, double rY, double rZ)
{
	scaleX = sX;
	scaleY = sY;
	scaleZ = sZ;
