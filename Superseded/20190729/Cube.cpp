...
triangle3dV* Cube::getTriangleData()
{
	...
	//return t;
	return transformObject(this->getTotalPoly(), t, scaleX, scaleY, scaleZ,
		moveX, moveY, moveZ, rotX, rotY, rotZ);
...
/*triangle3dV* Cube::getTriangleDataT()
{
	return transformObject(this->getTotalPoly(), this->getTriangleData(), scaleX, scaleY, scaleZ,
		moveX, moveY, moveZ, rotX, rotY, rotZ);
}*/
...
/*void Cube::updateX(double newX)
{
	x = newX;
}


void Cube::updateY(double newY)
{
	y = newY;
}


void Cube::updateZ(double newZ)
{
	z = newZ;
}


void Cube::updateC(Uint32 colour)
{
	c = colour;
}


void Cube::updateS(double size)
{
	s = size;
}*/


/*void Cube::setScaleX(double p)
{
	scaleX = p;
}


void Cube::setScaleY(double p)
{
	scaleY = p;
}


void Cube::setScaleZ(double p)
{
	scaleZ = p;
}


void Cube::setMoveX(double p)
{
	moveX = p;
}


void Cube::setMoveY(double p)
{
	moveY = p;
}


void Cube::setMoveZ(double p)
{
	moveZ = p;
}


void Cube::setRotX(double p)
{
	rotX = p;
}


void Cube::setRotY(double p)
{
	rotY = p;
}


void Cube::setRotZ(double p)
{
	rotZ = p;
}*/


void Cube::setAllTransforms(double sX, double sY, double sZ, double mX, double mY, double mZ, double rX, double rY, double rZ)
{
	scaleX = sX;
	scaleY = sY;
	scaleZ = sZ;
