...
triangle3dV translateT(double x, double y, double z, triangle3dV T)
{
	...
	//T.An	= unitVector(subVectors(translate(x, y, z, T.An), { x, y, z, 1.0 }));
	//T.Bn	= unitVector(subVectors(translate(x, y, z, T.Bn), { x, y, z, 1.0 }));
	//T.Cn	= unitVector(subVectors(translate(x, y, z, T.Cn), { x, y, z, 1.0 }));
